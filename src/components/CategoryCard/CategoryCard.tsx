...
import { replaceUrl, truncateTextAfterWords } from '../../helpers/functions/helperFunctions';
    ...
    return (
        <Card classNames={{ body: styles.categoryCardAntBody, }} className={styles.categoryCardAnt}>
            <Flex style={{ flexDirection: 'column', rowGap: '5px' }}>
                <img style={{ width: '120px', height: '120px', objectFit: 'contain' }} src={replaceUrl(category.image)} alt="Category" />
